...
class CartProductAdapter(var list: ArrayList<OrdersProductList>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        var name = list[position].productName + " " + list[position].productType
        ...
        storageReference =
            FirebaseStorage.getInstance().reference.child("Products/" + list[position].imageId + ".jpg")
